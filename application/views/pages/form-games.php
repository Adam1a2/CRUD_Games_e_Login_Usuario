<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"></h1>
			...
			<div class="col-md-12">
					<?php if(isset($game)) : ?>
						<form action="http://localhost:70/Crud_CI/games/update/<?= $game['id'] ?>" method="post">
					<?php else : ?>
						<form action="http://localhost:70/Crud_CI/games/save" method="post">
					<?php endif; ?>
					...
					<div class="col-md-6">
							...
							<a href="http://localhost:70/Crud_CI/games" class="btn btn-danger btn-xs"><i class="fas fa-times"></i> Cancel</a>
						</div>
					</div>
				</form>
			</div>
